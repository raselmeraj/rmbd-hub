    ...
    <div className="min-h-screen w-full bg-[#e89e9e] flex flex-col relative overflow-hidden font-serif">
      ...
      <div className="w-full flex justify-between items-start p-6 md:p-10">
        ...
        <div className="text-center flex-1 -ml-20 md:-ml-24">
          ...
          <p className="text-[11px] font-sans text-black/50 mt-3 max-w-[280px] mx-auto leading-relaxed">
            RMBD Hub helps you connect and share with the<br/>people in your life.
          </p>
        </div>
      ...
      <div className="flex-1 flex flex-col md:flex-row px-6 md:px-12 lg:px-16 gap-8 items-center">
        ...
        <div className="flex-1 flex flex-col justify-center">
          ...
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-serif text-black leading-[0.9] mt-6">
            Talk<br/>
            <span className="italic font-light ml-2">less,</span><br/>
            connect<br/>
            <span className="italic font-light ml-8">more.</span>
          </h1>
          ...
          <div className="mt-8 bg-[#f5e6d8]/60 backdrop-blur-md rounded-2xl p-4 max-w-[320px] border border-white/40 shadow-sm">
            <div className="flex gap-3">
              ...
              <p className="text-[11px] font-sans leading-relaxed text-black/70">
                <span className="font-bold text-black">RMBD Hub</span> helps you connect and share with the people in your life. A warm, premium identity hub built for real conversations — from Dhaka to the world
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="flex-1 max-w-[400px] w-full">
          <div className="relative bg-[#fff6f0] rounded-[20px] p-6 md:p-7 shadow-[0_20px_60px_rgba(0,0,0,0.15)] border border-white/60">
            <div className="absolute -top-3 -right-2 bg-black text-white text-[8px] tracking-[0.15em] font-sans font-bold px-3 py-1.5 rounded-full flex items-center gap-2 shadow-lg rotate-[8deg]">
              RMBD-HUB FINAL
            ...
            <h2 className="text-2xl font-serif leading-tight text-black">Login your<br/><span className="italic">Identity</span></h2>
            <p className="text-[11px] font-sans text-black/50 mt-2 leading-relaxed">
              RMBD Hub helps you connect and share with<br/>the people in your life.
            </p>
            ...
            <div className="mt-6 space-y-4">
              <div>
                ...
                <div className="mt-2 relative">
                  <div className="absolute left-3 top-1/2 -translate-y-1/2 text-black/30">
                  ...
                  <input 
                    ...
                    placeholder="you@rmbd.hub or +880..."
                    className="w-full bg-[#f5e6d8]/70 border border-black/5 rounded-full pl-10 pr-4 py-3 text-[12px] font-sans placeholder:text-black/30 focus:outline-none focus:ring-2 focus:ring-black/10"
                  />
                </div>
              </div>
              ...
              <div>
                <div className="flex justify-between items-center">
                  <label className="text-[11px] font-sans font-semibold text-black/70">Password</label>
                  <a href="#" className="text-[10px] font-sans underline text-black/50">Recovery Password</a>
                </div>
                <div className="mt-2 relative">
                  <div className="absolute left-3 top-1/2 -translate-y-1/2 text-black/30">
                  ...
                  <input 
                    ...
                    placeholder="••••••••••"
                    className="w-full bg-[#f5e6d8]/70 border border-black/5 rounded-full pl-10 pr-10 py-3 text-[12px] font-sans placeholder:text-black/30 focus:outline-none focus:ring-2 focus:ring-black/10"
                  />
                  <div className="absolute right-3 top-1/2 -translate-y-1/2 text-black/30 cursor-pointer">
              ...
              <div className="flex justify-between items-center pt-1">
                <label className="flex items-center gap-2 cursor-pointer">
                  <div className="w-8 h-5 rounded-full bg-black flex items-center p-0.5">
                    <div className="w-4 h-4 rounded-full bg-white"></div>
                  </div>
                  <span className="text-[11px] font-sans text-black/60">Remember me</span>
                </label>
                <span className="text-[9px] font-sans text-black/40">Secure - Encrypted</span>
              </div>

              <button className="w-full bg-black text-white rounded-full py-3.5 text-[13px] font-sans font-medium flex items-center justify-center gap-2 hover:bg-black/90 transition mt-2">
                Login
              ...
              <p className="text-[9px] font-sans text-black/30 text-center leading-relaxed">
                By continuing you agree to RMBD Hub Terms & Privacy
              </p>
            </div>
          </div>
        </div>
